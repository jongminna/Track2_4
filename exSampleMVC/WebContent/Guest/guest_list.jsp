	...
	<c:forEach var="guest" items="${list}">		
	   <tr onMouseOver="style.backgroundColor='#D1EEEE'" onMouseOut="style.backgroundColor=''">
        ...
        <font face="돋움" size="2" color="#000000">
		   <a class="list" href="/Guest?cmd=guest_view&idx=${guest.idx}">${guest.subject}</a></td>
	...
	<table width="600">
		<tr>
			...
			<td width="50%" align="center">
				<table>
					<form name="gsearch" method="post" action="/Guest?cmd=guest_list">	
			...
			<a href="/Guest?cmd=guest_write&page=${page}"><img src="/Board/img/write.gif" border="0"></a>
			</td>
		</tr>
	</table>
</body>
