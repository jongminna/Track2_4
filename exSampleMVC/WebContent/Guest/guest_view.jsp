...
//	 var urlString;
//   urlString = "/Guest?cmd=guest_delete&idx="+idx ;
//    window.open(urlString, "del_list"," resizable=no,x=150,y=150,width=300,height=170");
	bool = confirm('삭제할가요?')
	if(bool==true){
		location.href="/Guest?cmd=guest_delete&idx="+idx ;
	}else{
		return;
	}
 }
 ...
 <body topmargin="0" leftmargin="0">
   <table border="0" width="800">
     <tr>
      ...
      <font size="2">
       <!-- 목록보기 -->
       <a href="/Guest?cmd=guest_list"><img src="/Guest/img/list-2.gif" border="0"></a>&nbsp;&nbsp;&nbsp;&nbsp;
       <!-- 수정 -->
       <a href="/Guest?cmd=guest_modify&idx=${vo.idx}"><img src="/Guest/img/edit.gif" border="0"></a>&nbsp;&nbsp;&nbsp;&nbsp;
       <!-- 삭제 -->
       <a href="javascript:guest_del(${vo.idx})"><img src="/Guest/img/del.gif" border="0"></a>&nbsp;&nbsp;&nbsp;&nbsp;
      </font>
    </td>
  </tr>
  </table>
