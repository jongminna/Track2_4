	...
	<c:forEach var="notice" items="${list}">
	   <tr onMouseOver="style.backgroundColor='#D1EEEE'" onMouseOut="style.backgroundColor=''">
		  ...
		  <td align="left" height="20">&nbsp;
			 <font face="돋움" size="2" color="#000000"><a class="list" href="">${notice.subject}</a></td>
	...
	<table width="600">
		<tr>
			...
			<td width="50%" align="center">
				<table>
					<form name="nsearch" method="post" action="/Notice?cmd=notice_list">	
					<!-- 검색어를 이용하여 글제목, 작성자, 글내용 중에 하나를 입력 받아 처리하기 위한 부분 -->
						<tr>
							<td>
								<select name="search">
									<option value="subject" <c:if test="${query=='subject' }">selected</c:if>>제목</option>
									<option value="contents" <c:if test="${query=='contents' }">selected</c:if>>내용</option>
								</select>
							</td>
							<td> <input type="text" size=20 name="key" value="${key}"></td>
							<td> <a href="javascript:search()"><img src="/Notice/img/search2.gif" border="0"></a></td>
						</tr>
					</form>
				</table>
			</td>
