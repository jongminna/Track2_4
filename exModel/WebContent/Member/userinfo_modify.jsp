					...
					<td bgcolor="#7AAAD5">            
						...
						<table cellpadding=3 cellspacing=1 border=0 width=100%>
							<tr>
								...
								<TD BGCOLOR=WHITE>
									<input type=text name=name size=16 readonly maxlength=20 value="<%=vo.getName() %>">성명은 빈칸없이 입력하세요.
								</td>
							</tr>
							<tr>
								...
								<TD BGCOLOR=WHITE>
									<table cellspacing=0 cellpadding=0>
										<tr>
											<td align=absmiddle>
												<input type=text name=userid readonly size=12 maxlength=16 value="<%=vo.getUserid() %>" style="width:120">
											</td>
							...
							<tr>
								...
								<TD BGCOLOR=WHITE>
									<table cellspacing=0 cellpadding=0>
										<tr>
											<td><input type=text name=zip size=6 maxlength=6 value="<%=vo.getZip() %>"></td>
