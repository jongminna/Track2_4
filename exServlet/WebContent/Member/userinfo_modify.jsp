...
<%@ page import="exServlet.model.member.*" %>
<%
...
<tr>
  ...
  <td width="80%" valign="top">&nbsp;<img src="/Member/img/title1.gif" ><br>    
	<form name="member" method="post" action="userinfo_insert.do">
						...
						<table cellpadding=3 cellspacing=1 border=0 width=100%>
							...
							<tr>
								...
								<TD BGCOLOR=WHITE>
									<table cellspacing=0 cellpadding=0>
										<tr>
											<td align=absmiddle>
												<input type=text name=userid size=12 maxlength=16 readonly value="<%= vo.getUserid() %>" style="width:120">
											</td>
							...
							<tr>
								...
								<TD BGCOLOR=WHITE>
									<table cellspacing=0 cellpadding=0>
										<tr>
											<td><input type=text name=zip size=6 readonly maxlength=6 value="<%= vo.getZip() %>"></td>
							...
							<tr>
								...
								<TD BGCOLOR=WHITE>
									<select name=job class="formbox">
 										...
 										<option value="일반자영업" <% if(vo.getJob().equals("일반자영어")){ %> selected <% } %>>일반자영업
