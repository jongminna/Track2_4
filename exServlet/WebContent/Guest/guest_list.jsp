...
<%@ page import="exServlet.model.guest.*, java.util.*" %>
<%
...
%>
		<tr onMouseOver="style.backgroundColor='#D1EEEE'" onMouseOut="style.backgroundColor=''">
          ...
          <td align="left" height="20"><font face="돋움" size="2" color="#000000"><a href="guest_view.do?idx=<%= list.get(x).getIdx() %>&page=${page}"><%=list.get(x).getSubject() %></a></td>
				...
				<table>
					...
					<!-- 검색어를 이용하여 글제목, 작성자, 글내용 중에 하나를 입력 받아 처리하기 위한 부분 -->
						<tr>
							...
							<td> <a href="javascript:g_search()"><img src="/Guest/img/search2.gif" border="0"></a></td>
						</tr>
					</form>
				</table>
			</td>
